...
CREATE INDEX idx_textbook_chapters_textbook ON textbook_chapters(textbook_id, chapter_index);
...
CREATE INDEX idx_textbook_progress_user ON textbook_reading_progress(user_id, completed, last_read_at DESC);

CREATE TABLE course_unit_readings (
...
CREATE INDEX idx_course_unit_readings_unit ON course_unit_readings(course_unit_id, sort_order);
